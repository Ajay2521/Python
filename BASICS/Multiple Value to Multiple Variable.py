#In this lets see the concept of "Assigning Multiple value to multiple variable" in Python Programming.
...
#Here is the program for "Assigning Multiple value to multiple variable" .

#declaring and assigning a value to a variable

a , b , c = 10 , 10.2123 , "Maayon"
